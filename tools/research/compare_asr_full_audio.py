...
Typical usage:
    ...
    PYTHONPATH=src .venv-inference/bin/python tools/research/compare_asr_full_audio.py run \
        --wav data/devset/audio/ccpXHNfaoy.wav \
        --eval-mode both \
        --output-dir outputs/asr_compare_ccpXHNfaoy

    PYTHONPATH=src python3 tools/research/compare_asr_full_audio.py plot \
...
def run_segmented_reference_eval(
    *,
    ...
    from alignatt4llm.audio import load_audio_mono_16khz
    from alignatt4llm.runtime import CascadeRuntimeConfig, LoadedModelBundle
