...
output directory can be fed directly to `alignatt-eval
...
from alignatt4llm.audio import load_audio_mono_16khz  # noqa: E402
...
def main() -> None:
    ...
    print(
        ...
        f"  -> feed this dir to alignatt-eval --skip-comet"
    )
