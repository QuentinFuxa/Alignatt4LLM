...
from cascade.runtime import gemma_model_name  # noqa: E402
from run_alignment_single_audio import load_wav  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    default_mcif_root = Path("/tmp/iter106-index-cR5Si3/inputs/en/mcif-long-trans")
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--model", default=gemma_model_name)
    parser.add_argument("--wav-dir", type=Path, default=default_mcif_root / "audio")
    parser.add_argument("--segmentation", type=Path, default=default_mcif_root / "audio-segments.yaml")
    parser.add_argument("--reference", type=Path, default=default_mcif_root / "ref/en.txt")
