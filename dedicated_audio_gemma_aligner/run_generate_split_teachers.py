...
Usage:
    .venv-inference/bin/python dedicated_audio_gemma_aligner/run_generate_split_teachers.py [--manifest PATH]
"""
...
from dedicated_audio_gemma_aligner.paths import FULL_SPLIT_MANIFEST, TEACHER_DIR

DEFAULT_MANIFEST = FULL_SPLIT_MANIFEST
