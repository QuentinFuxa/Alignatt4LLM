...
Usage:
    /home/fuxa/iwslt-2026-baselines/.venv-inference/bin/python dedicated_audio_gemma_aligner/run_gemma_feature_aligner_eval.py
"""
...
from dedicated_audio_gemma_aligner.gemma_audio_features import extract_audio_features
from dedicated_audio_gemma_aligner.gemma_feature_aligner import TranscriptAudioAligner
from dedicated_audio_gemma_aligner.run_gemma_feature_aligner_train import (
    CHECKPOINT_DIR,
    DEVICE,
    DTYPE,
    MANIFEST_PATH,
