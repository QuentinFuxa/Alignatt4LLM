#!/usr/bin/env python3
"""Threshold robustness test: scalar substitution at threshold 0.05
instead of 0.015. If BOTH produce bit-identical online output vs the
discrete reference, the substitution is threshold-insensitive across
the sweet-spot range, strengthening the paper's drop-in replacement
claim.
"""
...
def main():
    ...
    cfg.translation_source_frontier_scalar_threshold = 0.05  # upper sweet-spot

    print("Loading models (scalar, threshold 0.05) ...", flush=True)
