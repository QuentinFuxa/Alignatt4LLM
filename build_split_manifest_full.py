...
GOLD_DIR = Path("acl-speech/segmented_wavs/gold")
TEXT_FILE = Path("acl-speech/text/txt/ACL.6060.eval.en-xx.en.txt")
OUTPUT = Path("tmp/feature_aligner/split_manifest_full.json")
