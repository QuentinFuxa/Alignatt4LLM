"""vLLM-side Q/K observer for MT AlignAtt.

This is a close analogue of ``cascade.alignment.gemma_vllm_asr_backend._AudioQKTensorObserver``
...
this module would need a shared dispatcher. The shipped runtime pairs
