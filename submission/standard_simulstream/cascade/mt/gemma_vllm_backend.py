"""Gemma MT backend via vLLM.

Mechanics rewrite of the Transformers MT backend under vLLM, with the MT
AlignAtt observer and the 4-way provenance partition that the runtime policy
needs.
