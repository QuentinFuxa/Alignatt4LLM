...
class VLLMAlignAttGemmaMTBackend(BaseMTBackend):
    ...
    def load(self) -> None:
        ...
        if not self.alignatt_heads:
            raise RuntimeError(
                "VLLMAlignAttGemmaMTBackend requires translation_alignatt_heads_path "
        ...
        if self.llm is None:
            ...
            try:
                self.llm = LLM(
                    ...
                    worker_cls="gemma_vllm_mt_worker.GemmaMTAlignAttWorker",
                )
            finally:
